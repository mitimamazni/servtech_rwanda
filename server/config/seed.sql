...
=======
('1199880012345678', 'Jean', 'Habimana', '1988-03-15', 'Gabo', 'Kigali'),
('1199920023456789', 'Marie', 'Uwimana', '1992-07-22', 'Gore', 'Musanze'),
('1199750034567890', 'Pierre', 'Nkurunziza', '1975-11-08', 'Gabo', 'Huye'),
('1200000045678901', 'Diane', 'Mukamana', '2000-01-30', 'Gore', 'Rubavu'),
('1199850056789012', 'Claude', 'Bizimana', '1985-05-12', 'Gabo', 'Nyagatare'),
('1199930067890123', 'Grace', 'Ingabire', '1993-09-04', 'Gore', 'Kigali'),
('1199680078901234', 'Emmanuel', 'Nshimiyimana', '1968-12-19', 'Gabo', 'Muhanga'),
('1199970089012345', 'Solange', 'Uwitonze', '1997-04-27', 'Gore', 'Rwamagana'),
('1199820090123456', 'Patrick', 'Hakizimana', '1982-08-03', 'Gabo', 'Kigali'),
('1199910001234567', 'Chantal', 'Murekatete', '1991-06-14', 'Gore', 'Nyanza');
...
('Admin User',    'admin@servtech.rw',  '$2a$10$5jd0iNPejQqEa94U0T/gSu7tMQHJU3pKePLQj.cJvHgcgUrWX46Fe', 'admin', '0781000000'),
('Agent One',     'agent@servtech.rw',  '$2a$10$gXmNqlP2FZuRKARoYHKRheI/HaYgNVG9o30pufJZxt1m5RsgPZWMq', 'agent', '0782000000'),
('Jean Habimana', 'jean@example.rw',    '$2a$10$YKKyDMRoaL6Q7T3Y5V8LzuuT3GHeYMaRF1oQc0XxMB1RNdnX3cBHC', 'client', '0783000001'),
('Marie Uwimana', 'marie@example.rw',   '$2a$10$YKKyDMRoaL6Q7T3Y5V8LzuuT3GHeYMaRF1oQc0XxMB1RNdnX3cBHC', 'client', '0783000002'),
('Patrick Hakizimana', 'patrick@example.rw', '$2a$10$YKKyDMRoaL6Q7T3Y5V8LzuuT3GHeYMaRF1oQc0XxMB1RNdnX3cBHC', 'client', '0783000003');

-- Clients table (linked to user accounts)
INSERT INTO clients (user_id, id_number, first_name, last_name, date_of_birth, gender, phone, district, status, registered_by) VALUES
(3, '1199880012345678', 'Jean',    'Habimana',    '1988-03-15', 'Gabo',   '0783000001', 'Kigali', 'verified', 2),
(4, '1199920023456789', 'Marie',   'Uwimana',     '1992-07-22', 'Gore', '0783000002', 'Musanze','verified', 2),
(5, '1199820090123456', 'Patrick', 'Hakizimana',  '1982-08-03', 'Gabo',   '0783000003', 'Kigali', 'verified', 1);
>>>>>>> 9db6d6819db7fd9c6c82e857825fdc88fc7fd189
